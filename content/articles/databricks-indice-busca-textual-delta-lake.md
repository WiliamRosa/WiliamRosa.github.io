...
O Databricks MVP Hubert Dudek publicou um artigo detalhando um benchmark prático do índice de busca textual que chegou em Beta na Databricks Runtime 18.2. No cenário mais favorável que ele testou, uma busca por um termo de dez caracteres num warehouse serverless pequeno (2XS) caiu de mais de 4260 segundos fazendo varredura completa pra pouco mais de 10 segundos usando o índice, uma diferença de quase 400 vezes. Não é ajuste fino de configuração, é mudança de classe de problema, do tipo que decide se uma tela de busca em produção é usável ou não.

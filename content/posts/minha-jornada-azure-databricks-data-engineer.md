...
<!-- Escreva aqui sua motivação: contexto profissional, o que te levou a estudar Databricks especificamente -->

## Como me preparei

<!-- Materiais de estudo, cursos, labs práticos, tempo de dedicação -->

## Principais tópicos do exame

<!-- Delta Lake, Unity Catalog, Delta Live Tables, otimização de jobs, segurança e governança, etc -->

## O que mais me surpreendeu

<!-- Algum conceito que mudou sua forma de pensar sobre engenharia de dados -->
